...
execute as @s[tag=kilab.creator,nbt={SelectedItem:{id:"minecraft:nether_star",tag:{swansCustom:"starlight"}}}] run function kilab:items/starlight_plus