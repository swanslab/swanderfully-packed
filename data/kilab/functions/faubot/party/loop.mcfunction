...
execute as faunaceres at @s if entity @a[distance=..2,name=!"faunaceres",limit=1,sort=nearest] run player faunaceres stop

# And moves again when they are away
execute as faunaceres at @s if entity @a[distance=3..,name=!"faunaceres",limit=1,sort=nearest] run player faunaceres move forward

# Dynamic sprinting based on distance
execute as faunaceres at @s if entity @a[distance=4..,name=!"faunaceres",limit=1,sort=nearest] run player faunaceres sprint
execute as faunaceres at @s if entity @a[distance=..4,name=!"faunaceres",limit=1,sort=nearest] run player faunaceres unsprint
